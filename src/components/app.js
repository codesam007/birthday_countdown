  ...
  renderItems = function() {
    if (this.state.active) {
      return [
        ...
        <label key={3} className="grid_remaining">
  ...
  render() {
    return (
      <div className="grid">
        ...
        <div className="grid_skew-dark-two" />
        <div className="grid_skew-dark-three" />

        <div className="grid_skew-light-one" />
        <div className="grid_skew-light-two" />
        <div className="grid_skew-light-three-box" />
